<div class="min-h-screen bg-gradient-to-b from-white to-gray-50">
  ...
  <div class="max-w-7xl mx-auto px-6 py-16 md:py-24">
    ...
    <!-- Mission Cards -->
    <div class="grid md:grid-cols-3 gap-6 md:gap-8 mt-16">
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Structured Datasets</h3>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Reproducible Benchmarking</h3>
        <p class="text-gray-600">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Open-Source Tools</h3>
        <p class="text-gray-600">
    ...
    <div class="mt-16 text-center">
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a href="/dataset" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
          Browse Datasets
        </a>
      </div>
    </div>
